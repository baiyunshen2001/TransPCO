...
intersect_min_12 <- function(W,u10,v10,u20,v20,dec.u = 0, dec.v = 0,prec.grid.u =1000, prec.grid.v =1000, max.iter = 200,method = c("both"),verbose = FALSE){
...
archie_work <- function(W,K = NULL, dec.u = 0, dec.v = 0,prec.grid.u =1000, prec.grid.v =1000,method = c("both"),verbose = TRUE){
