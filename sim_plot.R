...
png(filename = "power_simulation_samplesize_module4.png",width = 500,height = 300)

ggplot(data=res.alt,aes(x=sample_size,y=power,color=Method,group=Method))+
  geom_line(size=1)+
  geom_point()+
  labs(x="Sample Size",y="Power",title = " Power of three methods across different sample sizes module4")
